...
import { setDialog, setUserData } from "../../redux/reducers/authReducer";
...
export default function Auth() {
    ...
    let isLoginOpen = useSelector((state: RootState) => state.auth.isLoginOpen);
    let isLoad = useSelector((state: RootState) => state.auth.isLoad);
